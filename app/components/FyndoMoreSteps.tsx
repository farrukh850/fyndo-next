...
function FyndoMoreSteps({ id }: { id: string }) {
  ...
  return (
    <section id={id} className="pb-[59px] lg:pb-[139px] px-2.5 lg:px-0">
        ...
        <h2 className="text-[43px] leading-[44px] lg:text-[47.63px] mt-2 lg:h-[164px] lg:leading-[60px] tracking-[-1px] text-black font-bagoss text-left lg:text-center lg:max-w-[60%] w-full mx-auto whitespace-pre-line">{t('fyndo-steps-heading2')}</h2>
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between mt-[67px] gap-10 max-w-[1140px] mx-auto">
            <div className="flex flex-col gap-[15px] flex-1 text-center lg:text-left">
                ...
                <p className="text-sm leading-[19px] text-[#717179] font-inter whitespace-pre-line">{t('fyndo-stepfour-subheading')}</p>
            </div>
            <div className="flex flex-col gap-[15px] flex-1 text-center lg:text-left">
                <div className="w-full h-[319px] rounded-2xl overflow-hidden">
                ...
                <p className="text-sm leading-[19px] text-[#717179] font-inter whitespace-pre-line">{t('fyndo-stepfive-subheading')}</p>
            </div>
            <div className="flex flex-col gap-[15px] flex-1 text-center lg:text-left">
                <div className="w-full h-[319px] rounded-2xl overflow-hidden">
                ...
                <p className="text-sm leading-[19px] text-[#717179] font-inter whitespace-pre-line">{t('fyndo-stepsix-subheading')}</p>
            </div>
        </div>
    </section>
  )

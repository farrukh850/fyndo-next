...
function FyndoPackages({ id, idtwo }: { id: string; idtwo: string }) {
  ...
  return (
    <section id={id} className="pt-[33px] px-2.5 lg:px-0 lg:pt-[60px] pb-0 lg:pb-[110px] bg-[#F7F6F3] rounded-2xl lg:scroll-mt-[120px]">
        ...
        <h2 className="text-[43px] leading-[44px] tracking-[1px] lg:text-[47.63px] mt-8 h-auto lg:h-[164px] lg:leading-[60px] lg:tracking-[-1px] text-black font-bagoss lg:text-center text-left lg:whitespace-pre-line">{t('Easy_title')}</h2>
        ...
        <div id={idtwo} className="flex flex-col-reverse lg:flex-row items-stretch gap-2 mt-4 justify-end max-w-[1168px] mx-auto lg:scroll-mt-[120px]">
